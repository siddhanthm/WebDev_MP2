...
$(document).ready(function(){
    ...
    if($(window).width()>640){
	    ...
	    if(number ==1){
	    	$(".front-page").css({"background-image": "url('../public/data/pics/home1.jpg')"});
	    }else if(number ==2){
	    	$(".front-page").css({"background-image": "url('../public/data/pics/home2.jpeg')"});
	    }else if(number == 3){
	    	$(".front-page").css({"background-image": "url('../public/data/pics/home3.jpg')"});
	    }else if(number ==4){
	    	$(".front-page").css({"background-image": "url('../public/data/pics/home4.jpg')"});
	    }else if(number == 5){
	    	$(".front-page").css({"background-image": "url('../public/data/pics/home2.jpeg')"});
	    }else{
	    	$(".front-page").css({"background-image": "url('../public/data/pics/home6.jpg')"});
	    }
	}else{
		$(".front-page").css({"background-image": "url('../public/data/pics/home_s.jpg')"});
    }
